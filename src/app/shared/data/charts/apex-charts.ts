...
export let areaSplineChart: ChartOptions | any = {
    chart: {
        height: 350,
        type: 'area',
        toolbar: {
...
export let bubbleChart: ChartOptions | any = {
    chart: {
        height: 350,
        type: 'bubble',
        toolbar: {
...
export let pieChart: ChartOptions | any = {
    chart: {
        width: 380,
        type: 'pie',
    },
...
export let donutChart: ChartOptions | any = {
    chart: {
        width: 380,
        type: 'donut',
    },
...
export let mixedChart: ChartOptions | any = {
    chart: {
        height: 350,
        type: 'line',
        stacked: false,
...
// Radar Chart
export let candlestickChart: ChartOptions | any = {
    chart: {
        height: 350,
        type: 'candlestick',
        toolbar: {
...
export let radarChart: ChartOptions | any = {
...
export let radialBarChart: ChartOptions | any = {
    chart: {
        height: 350,
        type: 'radialBar',
    },
