...
export const commonInfoColorCardData: info[] = [
    ...
    },
    {
        ...
        textFooterClass : 'txt-light',
        heading: 'Info Color Footer',
        title: 'Web Developer',
        desc: 'A programmer who uses the client-server architecture to create World Wide Web applications is known as a web developer. The apps generally employ any general-purpose programming language on the server and HTML, CSS, and JavaScript on the client. specialist to inject some much-needed creativity.',
    },
]