export const LeftRibbons = [
    ...
    {
        class: 'ribbon-wrapper border border-1 height-equal alert-light-light bg-light-primary',
    ...
    {
        class: 'ribbon-wrapper border border-1 height-equall',
    ...
    {
        class: 'ribbon-vertical-left-wrapper border border-1 vertical-lp-space height-equal alert-light-light bg-light-primary',
    ...
    },
    {
        ...
        info: 'Cashback 20%',
        dis: ' Although the majority of the <em class="txt-danger">ribbon components</em> on this list have static, straightforward styles, we have also gathered dynamic ribbons.'
    },
    {
        class: 'ribbon-wrapper-bottom border border-1 clip-bp-space height-equal alert-light-light bg-light-primary',
...
export const RightRibbons = [
    ...
    {
        class: 'ribbon-wrapper-right border border-1 height-equal alert-light-light bg-light-primary',
    ...
    {
        class: 'ribbon-vertical-right-wrapper border border-1 vertical-rp-space height-equal alert-light-light bg-light-primary',
