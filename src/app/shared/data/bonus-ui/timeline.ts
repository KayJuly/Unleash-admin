export const basicTimeline = [
    {
        class: 'primary',
        time: '<span class="date-content light-background txt-dark">2 Feb 2024</span><span>7:00 AM</span>',
        title: 'CONFERENCE WITH CLIENT',
        dis: 'At noon today, there will be a meeting with a UK client.'
    },
    {
        class: 'secondary',
        time: '<span class="date-content light-background txt-dark">22 March 2024</span><span>3:45 PM</span>',
        title: 'DISCUSSION WITH MARKETING TEAM',
        dis: 'discussion with the marketing staff on the success of the most recent project'
    },
    {
        class: 'success',
        time: '<span class="date-content light-background txt-dark">16 May 2024</span><span>1:22 AM</span>',
    ...
    {
        class: 'warning',
        time: '<span class="date-content light-background txt-dark">23 Nov 2024</span><span>6:56 AM</span>',
        title: 'DISCUSSION WITH DESIGNER TEAM',
        dis: 'discussion with the designer employee on the success of the most recent project.'
    },
    {
        class: 'info',
        time: '<span class="date-content light-background txt-dark">12 Dec 2024</span><span>12:05 AM</span>',
        title: 'DISCUSSION WITH NEW THEME LAUNCH ',
        dis: 'discussion with the how many themes made in our portfolio'
    },
    {
        class: 'danger',
        time: '<span class="date-content light-background txt-dark">02 Jan 2024</span><span>6:56 AM</span>',
