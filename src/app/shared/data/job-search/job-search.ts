...
export const jobCardsData = [
   {
      ...
      desc : 'We are looking for an experienced and Unleash designer and/or frontend engineer with expertise in accessibility to join our team , 3+ years of experience working in as a Frontend Engineer or comparable role. You won’t be a team of one though — you’ll be collaborating closely with other...',
      tag : true,
      tagTitle : 'New',
      tagColor : 'primary',
      ribbion : false,
