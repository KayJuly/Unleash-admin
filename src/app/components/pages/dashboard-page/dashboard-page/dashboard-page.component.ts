...
@Component({
    ...
    standalone: true,
    imports: [CalendarCommonModule, NgSwitch, NgSwitchCase, CalendarMonthModule, CalendarWeekModule, CalendarDayModule, FormsModule, FlatpickrModule, JsonPipe, FaIconComponent, FontAwesomeModule, CommonSvgIconComponent, RouterLink, WeeklyUserActivityComponent, SummaryComponent, FeathericonComponent],
})
